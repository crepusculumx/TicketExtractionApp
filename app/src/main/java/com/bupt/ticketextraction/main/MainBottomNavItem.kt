...
sealed class MainBottomNavItem(
    ...
    object Receipt : MainBottomNavItem("发票", R.drawable.ic_baseline_receipt_24, 0.dp, 30.dp)
    object Settings : MainBottomNavItem("设置", R.drawable.ic_baseline_settings_24, 30.dp, 0.dp)
}